...
import com.antwerkz.bottlerocket.configuration.mongo36.blocks.LogComponent
...
class Component(
        ...
        var ftdc: LogComponent.Ftdc = LogComponent.Ftdc(),
    ...
    fun ftdc(init: LogComponent.Ftdc.() -> Unit) {
        ftdc = initConfigBlock(LogComponent.Ftdc(), init)
    }
